...
exports = module.exports = function processor(FfmpegCommand) {
  ...
  FfmpegCommand.prototype._process = function(target, pipeOptions) {
    var isStream;
    ...
    function doProcess() {
      ...
      self._prepare(function(err) {
        ...
        self.ffmpegProc.stderr.on('data', function (data) {
          ...
          if (self.listeners('progress').length && self.metaData && typeof self.metaData.durationsec === 'number') {
  ...
  FfmpegCommand.prototype.buildFfmpegArgs = function(overrideOutputCheck) {
    var args = [];
