...
module.exports = function(FfmpegCommand) {
  var proto = FfmpegCommand.prototype;
   ...
   * @static
   */
  FfmpegCommand.forgetPaths = function() {
   ...
   * @static
   */
  FfmpegCommand.setFfmpegPath = function(ffmpegPath) {
   ...
   * @static
   */
  FfmpegCommand.setFfprobePath = function(ffprobePath) {
    cache.ffprobePath = ffprobePath;
  };

  /**
   * Manually define the flvtool binary full path.
   * 
   * @param {String} flvtool The full path to the ffprobe binary.
   * @static
   */
  FfmpegCommand.setFlvtoolPath = function(flvtool) {
   ...
   * @static
   */
  FfmpegCommand.getFfmpegPath = function(callback) {
   ...
   * @static
   */
  FfmpegCommand.getFfprobePath = function(callback) {
    ...
    async.waterfall([
      ...
      function(ffprobe, cb) {
        ...
        FfmpegCommand.getFfmpegPath(function(err, ffmpeg) {
          if (err) {
            cb(err);
   ...
   *
   * @method FfmpegCommand#getFlvtoolPath
   * @param {Function} callback callback with signature (err, path)
   * @static
   */
  FfmpegCommand.getFlvtoolPath = function(callback) {
