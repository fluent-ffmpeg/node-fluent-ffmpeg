...
function parseProgressLine(line) {
  ...
  //If there is no dupplicated or dropped frames, initialized to 0.
  if(!progress.hasOwnProperty('dup'))
    progress['dup']=0;
  if(!progress.hasOwnProperty('drop'))
    progress['drop']=0;
  return progress;
}
  ...
  extractProgress: function(command, stderrLine) {
    ...
    if (progress) {
      ...
      var ret = {
        ...
        dup: parseInt(progress.dup,10), //duplicated frames
        drop: parseInt(progress.drop,10) //dropped frames
      };
